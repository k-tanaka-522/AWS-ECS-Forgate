 ...
 *
 * 目的: 管理者向けダッシュボード（VPN/Direct Connect経由のみアクセス可能）
 * 構成: Express.js + PostgreSQL
 * デプロイ: ECS Fargate (Internal ALB経由)
 */
...
const SERVICE_NAME = process.env.SERVICE_NAME || 'admin-dashboard';
...
async function startServer() {
  try {
    ...
    app.listen(PORT, '0.0.0.0', () => {
      ...
      console.log(`[${SERVICE_NAME}] Access: VPN/Direct Connect only`);
    });
  } catch (error) {
