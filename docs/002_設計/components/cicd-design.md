...
┌──────────┐     ┌───────────────┐     ┌─────────────────┐     ┌─────────────────┐     ┌─────────────┐
│          │     │               │     │                 │     │                 │     │             │
│ CodeCommit│────▶│ CodePipeline  │────▶│  CodeBuild      │────▶│  AWS ECR        │────▶│  ECS Fargate │
│          │     │               │     │                 │     │                 │     │             │
└──────────┘     └───────────────┘     └─────────────────┘     └─────────────────┘     └─────────────┘
      │                  │                      │                      │                     │
      │                  │                      │                      │                     │
...
プロジェクトはAWS CodeCommitの単一リポジトリ（モノリポ）で管理し、以下のディレクトリ構造を採用します：
...
3. AWS CodeCommitのプルリクエスト機能でコードレビュー
4. AWS CodeBuildでビルド、テスト、セキュリティスキャンを実施
